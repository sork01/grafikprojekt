...
light2 = add_light()
light_set_pos(light2, 50, 0, -8)
light_set_diffuse(light2, 250,250,250)
light_set_specular(light2, 250,250,250)
...
pawn = load_obj("models/deer.obj", "ACB")
-- pawn = load_obj("models/cornellbox.obj", "ABC")
mesh_flip_y(pawn)
...
sp1 = add_sphere(-16,0,6, 9, spheremat)
