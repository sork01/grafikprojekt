...
m5 = copy_material(m4)
material_set_ambient(m5, 0.01,0.01,0.01)
material_set_diffuse(m5, 0.12,0.12,0.12)
material_set_specular(m5, 20,20,20)
material_set_reflectivity(m5, 0.5, 0.5, 0.5)

pawn = load_obj("models/pawn.obj", "ABC")
mesh_flip_y(pawn)
mesh_scale(pawn, 0.05)
mesh_move(pawn, 0.5, 0.8, 0.3)
mesh_apply_material(pawn, m5)
